...
class Metaclass_MainBG_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pyturtle_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MainBG(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pyturtle_interfaces.srv.MainBG')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from pyturtle_interfaces.srv import _main_bg
...
class MainBG(metaclass=Metaclass_MainBG):
    from pyturtle_interfaces.srv._main_bg import MainBG_Request as Request
    from pyturtle_interfaces.srv._main_bg import MainBG_Response as Response
