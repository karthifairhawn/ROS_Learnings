...
static const _MainBG_Request_type_support_symbol_names_t _MainBG_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim, srv, MainBG_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim, srv, MainBG_Request)),
  }
};
...
{
  return &::turtlesim::srv::rosidl_typesupport_cpp::MainBG_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim, srv, MainBG_Request)() {
  return get_message_type_support_handle<turtlesim::srv::MainBG_Request>();
}
...
static const _MainBG_Response_type_support_symbol_names_t _MainBG_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim, srv, MainBG_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim, srv, MainBG_Response)),
  }
};
...
{
  return &::turtlesim::srv::rosidl_typesupport_cpp::MainBG_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim, srv, MainBG_Response)() {
  return get_message_type_support_handle<turtlesim::srv::MainBG_Response>();
}
...
static const _MainBG_type_support_symbol_names_t _MainBG_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim, srv, MainBG)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim, srv, MainBG)),
  }
};
...
{
  return &::turtlesim::srv::rosidl_typesupport_cpp::MainBG_service_type_support_handle;
}
