...
bool turtlesim__msg__main_bg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim.msg._main_bg.MainBG", full_classname_dest, 29) == 0);
  }
  turtlesim__msg__MainBG * ros_message = _ros_message;
  {  // r
...
{
  /* NOTE(esteve): Call constructor of MainBG */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim.msg._main_bg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MainBG");
