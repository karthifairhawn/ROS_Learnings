...
#include <stddef.h>
#include "turtlesim/srv/detail/main_bg__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember MainBG_Request__rosidl_typesupport_introspection_c__MainBG_Request_message_member_array[3] = {
  {
    ...
    offsetof(turtlesim__srv__MainBG_Request, r),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim__srv__MainBG_Request, g),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim__srv__MainBG_Request, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MainBG_Request__rosidl_typesupport_introspection_c__MainBG_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(turtlesim__srv__MainBG_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, MainBG_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember MainBG_Response__rosidl_typesupport_introspection_c__MainBG_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim__srv__MainBG_Response, sum),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MainBG_Response__rosidl_typesupport_introspection_c__MainBG_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(turtlesim__srv__MainBG_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_turtlesim
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, MainBG_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_members = {
  "turtlesim__srv",  // service namespace
  "MainBG",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_Request_message_type_support_handle,
  NULL  // response message
  // turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_type_support_handle = {
  0,
  &turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, MainBG)() {
  if (!turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_type_support_handle.typesupport_identifier) {
    turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, MainBG_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, MainBG_Response)()->data;
  }

  return &turtlesim__srv__detail__main_bg__rosidl_typesupport_introspection_c__MainBG_service_type_support_handle;
}
